...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom">
                <i class="fas fa-user-secret me-2"></i>Super Admin
            </div>
            <div class="list-group list-group-flush my-3">
                <a href="#" id="admin" class="list-group-item list-group-item-action bg-transparent second-text active d-flex align-items-center">
                    <span class="material-symbols-outlined me-2">admin_panel_settings</span>Admin
                </a>
                <a href="#" id="survey" class="list-group-item list-group-item-action bg-transparent second-text fw-bold d-flex align-items-center">
                    <span class="material-symbols-outlined me-2">ballot</span>Survey
                </a>
                <a href="#" id="question" class="list-group-item list-group-item-action bg-transparent second-text fw-bold d-flex align-items-center">
                    <span class="material-symbols-outlined me-2">question_mark</span>Pertanyaan
                </a>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container mt-4 mb-4">
                <div id="survey-content" class="content">
                    <div class="table-responsive">
                        <h3>Tabel Survei</h3>
                        <form id="survey-form" method="GET" action="{{ route('superadmin.show') }}">
    ...
    <script src="{{ asset('js/sidebarcontent.js') }}"></script>
    <script src="{{ asset('js/survei.js') }}"></script>
